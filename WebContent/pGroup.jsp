		...
		<div class="midside">
			...
			<div class="partmidside">
				...
				<div class="groupmember">
					<ul class="member">
						<c:if test="${fn:length(groupLists) eq 0}">Tidak Ada</c:if>
						<c:forEach var="group" items="${groupLists}">
							<li><a href="Controller?action=gDetail&gID=${group.getId()}">
									<img src="sources/images/group.png"> <br>${group.getGroupName()}
							</a></li>
						</c:forEach>
					</ul>
				</div>
